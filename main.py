...
final_classes = ["Жрець", "Чаклун", "Чарівник", "Маг", "Бард", "Друїд",
                 "Шахрай", "Воїн", "Варвар", "Рейнджер", "Паладин", "Монах"]
...
st.markdown("Переклад: cleric - жрець, warlock - чаклун, sorcerer - чарівник, wizard - маг, bard - бард, druid - друїд, ")
st.markdown("rogue - шахрай, fighter - воїн, barbarian - варвар, ranger - рейнджер, paladin - паладин, monk - монах.")
